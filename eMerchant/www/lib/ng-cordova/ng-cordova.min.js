  ...
  angular.module("ngCordova", ["ngCordova.plugins"]), angular.module("ngCordova.plugins.actionSheet", []).factory("$cordovaActionSheet", ["$q", "$window", function (e, n) {
    ...
    return {
      getCurrentHeading: function () {
        ...
        var o = e.defer(), r = angular.extend(n, t), i = navigator.compass.watchHeading(function (e) {
          o.notify(e)
        }, function (e) {
          o.reject(e)
        }, r);
    ...
    return {
      login: function (t) {
        var o = e.defer();
        return void 0 === t && (t = {}), n.plugins.googleplus.login({iOSApiKey: t}, function (e) {
          o.resolve(e)
        }, function (e) {
          o.reject(e)
        }), o.promise
        ...
        var o = e.defer();
        return void 0 === t && (t = {}), n.plugins.googleplus.trySilentLogin({iOSApiKey: t}, function (e) {
          o.resolve(e)
        }, function (e) {
          o.reject(e)
        }), o.promise
    ...
    return {
      isAvailable: function () {
        ...
        var o = e.defer();
        return t = t || "HKQuantityTypeIdentifierHeight", n.plugins.healthkit.checkAuthStatus({type: t}, function (e) {
          o.resolve(e)
        }, function (e) {
          o.reject(e)
        }), o.promise
        ...
        if (window.cordova) {
          ...
          if (a.hasOwnProperty("org.apache.cordova.inappbrowser") === !0)if ("undefined" != typeof jsSHA) {
            ...
            n({
              ...
              headers: {Authorization: u.authorization_header, "Content-Type": "application/x-www-form-urlencoded"},
              ...
              s.addEventListener("loadstart", function (e) {
                if (0 === e.url.indexOf("http://localhost/callback")) {
                  ...
                  n({
                    ...
                    params: {oauth_verifier: u.oauth_verifier}
                  }).success(function (e) {
