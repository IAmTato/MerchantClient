...
app.controller('LoginCtrl', ['$scope', '$state', '$ionicLoading', '$ionicPopup', 'AuthService',
  function ($scope, $state, $ionicLoading, $ionicPopup, AuthService) {
    ...
    $scope.login = function (data) {
      console.log(md5("Tato"));
      console.log(md5("Vincent"));
      console.log(md5("Tony"));
      console.log(md5("Bobby"));
      console.log(md5("Tato1"));
      console.log(md5("Tato2"));

      AuthService.login(md5(data.username), md5(data.password)).then(function (authenticated) {
          //$ionicLoading.hide();
