"use strict";
var dwrModule = angular.module("dwrModule",[])
dwrModule.service("icbcUtil",[function(){
var p = this;
(function() {
    if (dwr.engine._getObject("IcbcUtil") == undefined) {
        var cn = "IcbcUtil";
        p.getRemoteAddr = function (cb) {
            return dwr.engine.synremoter.call(p, cn, 'getRemoteAddr', arguments, cb);
        };
        p.getRemoteAddr.className = cn;
        p.getRemoteAddr.methodName = "getRemoteAddr";
        p.Execption2String = function (p0, p1, cb) {
            return dwr.engine.synremoter.call(p, cn, 'Execption2String', arguments, cb);
        };
        ...
        p.shutdownScheduledService = function (cb) {
            return dwr.engine.synremoter.call(p, cn, 'shutdownScheduledService', arguments, cb);
        };
